...
/**
 * SRS (Seattle Solvers) Hub - Multi-sensor I2C expansion device for FTC robots.
 *
 * <p>The SRSHub is a custom hardware device that provides:</p>
 * <ul>
 *   <li><b>12 Analog/Digital Ports:</b> Configurable as analog inputs (0-3.3V) or digital I/O</li>
 *   <li><b>6 Encoder Ports:</b> Support for quadrature and PWM encoders</li>
 *   <li><b>3 I2C Buses:</b> Connect I2C devices like ToF sensors, color sensors, IMUs</li>
 *   <li><b>Bulk Reading:</b> Single I2C transaction reads all sensors efficiently</li>
 *   <li><b>CRC Protection:</b> Data integrity checking for reliable communication</li>
 * </ul>
 *
 * <h3>Supported I2C Devices:</h3>
 * <ul>
 *   <li><b>VL53L5CX:</b> 4x4 or 8x8 ToF sensor array for distance measurement</li>
 *   <li><b>VL53L0X:</b> Single-point ToF sensor</li>
 *   <li><b>APDS-9151:</b> Color, light, and proximity sensor</li>
 *   <li><b>GoBilda Pinpoint:</b> Odometry computer for local positioning</li>
 * </ul>
 *
 * <h3>Usage Example:</h3>
 * <pre>{@code
 ...
 * // Read data in loop
 * hub.update();
 * double analogValue = hub.readAnalogDigitalDevice(1);
 * SRSHub.PosVel encoder = hub.readEncoder(1);
 * SRSHub.VL53L5CX tofData = hub.getI2CDevice(1, SRSHub.VL53L5CX.class);
 * }</pre>
 *
 * <h3>I2C Configuration:</h3>
 * <ul>
 *   <li><b>Default Address:</b> 0x57 (7-bit)</li>
 *   <li><b>Bus Speed:</b> 400kHz (Fast mode)</li>
 *   <li><b>Required Firmware:</b> v1.4.4</li>
 * </ul>
 *
 * <h3>Error Handling:</h3>
 * <p>The hub includes error detection and recovery:</p>
 * <ul>
 *   <li><b>CRC Checking:</b> All bulk reads include CRC-16 validation</li>
 *   <li><b>Disconnection Detection:</b> Monitor {@link #disconnected()} status</li>
 *   <li><b>Device Status:</b> I2C devices report disconnection individually</li>
 * </ul>
 *
 * @see SRSHub.Config
 * @see SRSHub.VL53L5CX
 * @see SRSHub.GoBildaPinpoint
 */
@I2cDeviceType
